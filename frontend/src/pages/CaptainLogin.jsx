...
const CaptainLogin = () => {
    ...
    return(
        <div className="p-7 h-screen  flex flex-col justify-between">
            ...
            <div>
                <Link to='/login' className="bg-[#d5622d] text-white flex justify-center items-center font-semibold mb-7 rounded px-4 py-2  w-full text-lg placeholder:text-base">Sign in as User</Link>
            </div>
        </div>
    )
}
