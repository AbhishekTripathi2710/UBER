            ...
            <div className="flex gap-2 justify-between items-center flex-col">
                ...
                <div className="mt-6">
                    <form onSubmit={(e)=>{
                        ...
                        <input value={otp} onChange={(e)=>setOtp(e.target.value)} className="bg-[#eee] px-6 py-4 text-base rounded-lg w-full mt-3" type="text" placeholder="Enter OTP"></input>
                        <Link to='/captain-riding' className="w-full text-lg mt-5 flex justify-center bg-green-600 text-white p-2 rounded font-semibold">Confirm</Link>
                        <button onClick={() => {
                            props.setConfirmRidePopupPanel(false)
                            props.setRidePopupPanel(false)
                        }} className="w-full mt-1 text-lg  bg-red-400 text-white p-3 rounded font-semibold">Cancel</button>
                    </form>
                </div>
            </div>
        </div>
