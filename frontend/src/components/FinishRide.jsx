    ...
    return (
        <div>
            <h5 className="p-1 text-center w-[93%] absolute top-0" onClick={() => {
                props.setFininshRidePanel(false)
            ...
            <div className="flex gap-2 justify-between items-center flex-col">
                ...
                <div className="mt-6">
                    <Link to='/captain-home' className="w-full mt-5 flex justify-center bg-green-600 text-white p-2 rounded font-semibold">Finish Ride</Link>
