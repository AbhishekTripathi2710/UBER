        ...
        <div>
            ...
            <div className="flex gap-2 justify-between items-center flex-col">
                ...
                <div className="mt-5 w-full flex items-center justify-between">
                    <button onClick={() => {
                        props.setRidePopupPanel(false)
                    }} className="mt-1 bg-gray-300 text-gray-700 p-3 px-10 rounded font-semibold">Ignore</button>
                    <button onClick={() => {
                        props.setConfirmRidePopupPanel(true)
                    }} className=" bg-green-600 text-white p-3 px-10 rounded font-semibold">Accept</button>
